 ...
 */
function BABY_LOUIE_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  // Work-around for a core bug affecting admin themes. See issue #943212.
  if (isset($form_id)) {
    return;
  }

  $form['theme_ui']['BABY_LOUIE_use_placeholders'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('BABY_LOUIE_use_placeholders'),
  );
}
