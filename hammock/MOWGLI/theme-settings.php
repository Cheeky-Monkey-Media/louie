 ...
 */
function MOWGLI_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  // Work-around for a core bug affecting admin themes. See issue #943212.
  if (isset($form_id)) {
    return;
  }

  $form['theme_ui']['MOWGLI_use_placeholders'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('MOWGLI_use_placeholders'),
  );
}
